              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Haloo !</h1>
                  </div>
                  <form class="user" method="POST" action="{{ route('login') }}">
                  {{ csrf_field() }}

                    <div class="form-group">
                      <input id="username" name="username" type="username" value="{{ old('username') }}" class="form-control form-control-user"  placeholder="Username ...">
                    </div>
                    <div class="form-group">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small">Masukkan Username dan Password</a>
                  </div>
                  <div class="text-center">
                    <a class="small">Dengan Benar ya !</a>
                  </div>
                </div>
              </div>
            </div>
